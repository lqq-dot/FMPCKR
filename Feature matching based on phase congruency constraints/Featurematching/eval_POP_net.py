...
def eval(args):
    ...
    image_info_now = {'image_row': 512, 'image_col': 512, 'max_point_num': 1000}
...
def main():
    ...
    parser.add_argument('--HPatches-path', type=str,
                        default='university',#'hpatches-sequences-release',
                        help='the path of hpatches sequences dataset')
    parser.add_argument('--POP-model-path', type=str,
                        default='save_POP_model/POP_43.pth', #default='save_POP_model/POP_net_pretrained.pth',
