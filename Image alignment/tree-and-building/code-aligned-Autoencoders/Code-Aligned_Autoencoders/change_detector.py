...
import datasets
import numpy as np
import numpy.typing._extended_precision as tep
...
class ChangeDetector:
    ...
    def __init__(self, **kwargs):
        ...
        if logdir is not None:
            ...
            self.extra_image_dir = tf.constant(os.path.join(self.log_path, "extra_images"))
        else:
            self.tb_writer = tf.summary.create_noop_writer()
            self.extra_image_dir = None  # Or some default value
