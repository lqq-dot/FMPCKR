   ...
   # @tf.function
    def __call__(self, inputs, training=False):
        ...
        if training:
            ...
            Xn_filename = tf.constant("E:/data-alignment/building/building-result") + tf.constant(f"/Xn.png")
            Yn_filename = tf.constant("E:/data-alignment/building/building-result") + tf.constant(f"/Yn.png")
