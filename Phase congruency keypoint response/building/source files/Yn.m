...
for i = 1:numRows
    for j = 1:numCols
        ...
        % 创建文件名
        filename = sprintf('E:/code/LGHD-master/building/result/Yn/normalized_image_%d_%d.png', i, j);
...
savePath = 'E:/code/LGHD-master/building/result/Yn/onePercentage_Image.png'
% 保存RGB图像
