...
%         title(['Image (' num2str(i) ', ' num2str(j) ')']);
        ...
        % 创建文件名
        filename = sprintf('E:/code/LGHD-master/tree-and-building/result/Yn/normalized_image_%d_%d.png', i, j);
...
savePath = 'E:/code/LGHD-master/tree-and-building/result/Yn/onePercentage_Image.png'
% 保存RGB图像
